...
public final class Parameters {
  ...
  private static void loadPreferences() {
    ...
    try {
      ...
      if (val != null) LAST_ROM_FILE_CHOSEN = val;
      val = prefs.get("lastROMURLChosen", null);
      if (val != null) LAST_ROM_URL_CHOSEN = val;
    } catch (Exception e) {
      // Give up
    }
  }
  ...
  private static void processProperties() {
    ...
    try {
      ...
      val = props.getProperty("CONSOLE_FAST_SPEED_FACTOR");
      if (val != null) CONSOLE_FAST_SPEED_FACTOR = Integer.valueOf(val);
      ...
      val = props.getProperty("SCREEN_QUALITY_RENDERING");
      if (val != null) SCREEN_QUALITY_RENDERING = Boolean.valueOf(val);
      ...
      if (val != null && !val.isEmpty()) CARTRIDGE_NAME = String.valueOf(val);
      val = props.getProperty("CARTRIDGE_LABEL");
      if (val != null && !val.isEmpty()) CARTRIDGE_LABEL = String.valueOf(val);
      val = props.getProperty("CARTRIDGE_LABEL_COLORS");
      if (val != null && !val.isEmpty()) CARTRIDGE_LABEL_COLORS = String.valueOf(val);
      ...
      if (val != null && !val.isEmpty()) CARTRIDGE_FORMAT = String.valueOf(val);
